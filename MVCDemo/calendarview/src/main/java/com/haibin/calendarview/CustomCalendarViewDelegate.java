...
//    private int mSelectMode;
    ...
    /**
     * 最小年份和最大年份对应最小月份和最大月份的最小天数个最大天数
     * when you want set 2015-07 to 2017-08
     */
...
//    Calendar mIndexCalendar;
    ...
    CustomCalendarViewDelegate(Context context, @Nullable AttributeSet attrs) {
        ...
        mWeekBarHeight = (int) array.getDimension(R.styleable.CalendarView_week_bar_height, CalendarUtil.dipToPx(context, 25));
        ...
        mDayTextSize = array.getDimensionPixelSize(R.styleable.CalendarView_day_text_size, CalendarUtil.dipToPx(context, 12));
        mLunarTextSize = array.getDimensionPixelSize(R.styleable.CalendarView_lunar_text_size, CalendarUtil.dipToPx(context, 10));
        mCalendarItemHeight = (int) array.getDimension(R.styleable.CalendarView_calendar_height, CalendarUtil.dipToPx(context, 25));
