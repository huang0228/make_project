...
public class ClassicConfig {
    ...
    static void createClassicViews(RelativeLayout layout) {
        ...
        textViewTitle.setId(com.sam.demo.R.id.sr_classic_title);
        ...
        textViewLastUpdate.setId(com.sam.demo.R.id.sr_classic_last_update);
        ...
        textContainer.setId(com.sam.demo.R.id.sr_classic_text_container);
        ...
        imageViewArrow.setId(com.sam.demo.R.id.sr_classic_arrow);
        ...
        imageViewArrowLP.addRule(RelativeLayout.LEFT_OF, com.sam.demo.R.id
        ...
        progressBar.setId(com.sam.demo.R.id.sr_classic_progress);
        ...
        progressBarLP.addRule(RelativeLayout.LEFT_OF, com.sam.demo.R.id
                .sr_classic_text_container);
