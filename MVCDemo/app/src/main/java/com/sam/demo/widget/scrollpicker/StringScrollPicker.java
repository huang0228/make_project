package com.sam.demo.widget.scrollpicker;
...
import com.sam.demo.util.ColorUtil;
/**
 * ================================================
 * 爱代码，不爱BUG
 * 作    者：赵腾飞
...
public class StringScrollPicker extends ScrollPickerView<CharSequence> {
    ...
    private int mMaxTextSize = 28; // 最大的字体
    // 字体渐变颜色
    private int mStartColor = MyApplication.getInstance().getResources().getColor(R.color.color_5a5e5d); // 中间选中ｉｔｅｍ的颜色
    private int mEndColor =  MyApplication.getInstance().getResources().getColor(R.color.color_898989); // 上下两边的颜色
